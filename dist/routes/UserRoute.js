...
router.get('/messages', Middleware_1.default.verifyToken, UserController_1.default.getMessages);
...
router.get('/messages/search', Middleware_1.default.verifyToken, UserController_1.default.searchMessages);
